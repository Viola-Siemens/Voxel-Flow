DROP TABLE IF EXISTS `user_story_rel`;

CREATE TABLE `user_story_rel` (
    ...
    `old_status` varchar(45) NULL COMMENT '故事旧状态',
    `new_status` varchar(45) NULL COMMENT '故事新状态',
...
) ENGINE=InnoDB CHARSET=utf8mb4 COMMENT='故事修改记录';